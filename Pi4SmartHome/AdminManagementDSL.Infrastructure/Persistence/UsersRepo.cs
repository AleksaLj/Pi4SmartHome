...
namespace AdminManagementDSL.Infrastructure.Persistence
{
    public class UsersRepo : IUsersRepo
    {
        ...
        public async Task<int> DeleteAsync(object id)
        {
            ...
            var cmd = new SqlCommand("mgmtdsl.Users_DeleteById", conn);
        ...
        {
            var item = default(Users);

            await using SqlConnection conn = new SqlConnection(SqlConnOptions.SqlConnection);
            var cmd = new SqlCommand("mgmtdsl.Users_SelectByEmail", conn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<bool> CheckIfEmailIsActivatedAsync(string email)
        {
            ...
            var cmd = new SqlCommand("mgmtdsl.Users_CheckIfEmailIsActivated", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Email", email);
            var outParam = new SqlParameter("@Result", SqlDbType.Int)
            {
        ...
        {
            await using SqlConnection conn = new SqlConnection(SqlConnOptions.SqlConnection);
            var cmd = new SqlCommand("mgmtdsl.Users_CheckSignInKeyForEmail", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Email", email);
        ...
        {
            await using SqlConnection conn = new SqlConnection(SqlConnOptions.SqlConnection);
            var cmd = new SqlCommand("mgmtdsl.Users_UpdateSignInKey", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Email", email);
            cmd.Parameters.AddWithValue("@SignInKey", signInKey);
            conn.Open();
        ...
        public async Task<IEnumerable<Users>> GetAllAsync()
        {
            ...
            await using SqlConnection conn = new SqlConnection(SqlConnOptions.SqlConnection);
            var cmd = new SqlCommand("mgmtdsl.Users_GetAll", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            conn.Open();
        ...
        public async Task<Users?> GetByIdAsync(object id)
        {
            ...
            await using SqlConnection conn = new SqlConnection(SqlConnOptions.SqlConnection);
            var cmd = new SqlCommand("mgmtdsl.Users_GetById", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@UserId", id);
            conn.Open();
        ...
        {
            await using SqlConnection conn = new SqlConnection(SqlConnOptions.SqlConnection);
            var cmd = new SqlCommand("mgmtdsl.Users_Insert", conn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            await using SqlConnection conn = new SqlConnection(SqlConnOptions.SqlConnection);
            var cmd = new SqlCommand("mgmtdsl.Users_Update", conn);
            cmd.CommandType = CommandType.StoredProcedure;
